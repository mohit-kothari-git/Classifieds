            ...
            while(true) {
                ...
                switch (choice) {
                    ...
                    case 3:
                        ...
                        auth.selectUser();
                        if(ClassifiedsSession.user.status == 1){
                    ...
                    case 5:
                        ...
                        System.out.println("1: Number of Classified");
                        System.out.println("2: Total sales");
                        System.out.println("3: Sales between the dates range");
                        System.out.println("4: List Inactive users");
                        System.out.println("5. List blocked classifieds");
                        choice = Integer.parseInt(scanner.nextLine());
